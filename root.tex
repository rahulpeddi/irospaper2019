...
While a thin-plate spline is continuous, and a result can be obtained with any combination of distance and time as an input pair, the accuracy of the results of any pair $(d_u,t_u)$ can suffer as the distance between evaluation points and training points increases. In order to quantify this, we use the standard error. The standard error is a 
...
The commands generated in the previous section are generated and sent to the UAV prior to any testing or evaluation. Therefore, 
