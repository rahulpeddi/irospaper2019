...
\end{itemize}
\NB{we need to stress how different this work is in comparison with the rest of the literature on learning from demosntration}
...
Solving the equation \ref{eq:minjerkint}, we obtain the form:
