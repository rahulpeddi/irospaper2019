...
The first experiments consisted of tracking straight line distances and diagonal distance, to validate that $x$ and $y$ components as discussed in Section~\ref{sec:traj} can be attained accurately. For straight line distances, we
