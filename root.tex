...
\begin{figure}[h]
	\centering
	\subfigure[X Error \label{fig:xerr}]{\includegraphics[width=0.9\linewidth]{images/XERR.png}}
    \subfigure[X Commands \label{fig:scmds}]{\includegraphics[width=0.9\linewidth]{images/CLOSEDXcmds.png}}
    \subfigure[Y Error \label{fig:yerr}]{\includegraphics[width=0.9\linewidth]{images/YERROR.png}}
    \subfigure[Y Commands \label{fig:ycmds}]{\includegraphics[width=0.9\linewidth]{images/CLOSEDYcmds.png}}
