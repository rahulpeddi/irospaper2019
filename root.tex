...
The open-loop commands however, may not accurately send the UAV to the target. The open-loop trial of the diagonal trajectory is presented in Fig.~\ref{fig:1723open}, where it is clear that the open-loop trajectory falls short of the target point. %\NB{where is the error plot?}
...
To show the effectiveness of our controller, we ran the same experiment. The results are depicted in Fig.~\ref{fig:1723controlled}. 
