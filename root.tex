...
Using the maximum distance for each point $\Delta_i$, we are able the generate intervals around each point, where the data is within the standard error of the estimate. Fig.\ref{fig:bounds}, contains a pictorial representation of the standard error intervals around each point. In Fig.\ref{fig:predsur}, the surface shown in Fig.\ref{fig:integs} is modified with the boundary created by the intervals. The boundary created by the intervals is simply a pictorial representation 
