...
The open-loop commands however, may not reach the target. During run-time, our controller is used to adjust these inputs based on any possible error.
The open-loop and version of the diagonal trajectories are presented in Fig.~\ref{fig:1723open}, where it is clear that the open-loop trajectory falls short of the target point. %\NB{where is the error plot?}
...
To show the effectiveness of our controller, we ran the same experiment. The new commands generated 

\begin{figure}[h]
	\centering
	\subfigure[X Commands \label{fig:oo}]{\includegraphics[width=0.48\linewidth]{images/1723open.png}}
    \subfigure[X Error \label{fig:1723close}]{\includegraphics[width=0.48\linewidth]{images/1723closed.png}}
    \subfigure[Y Commands \label{fig:1723close}]{\includegraphics[width=0.48\linewidth]{images/1723closed.png}}
    \subfigure[Y Error \label{fig:1723close}]{\includegraphics[width=0.48\linewidth]{images/1723closed.png}}
	\caption{Diagonal Trajectories of UAV Experiments}
	\label{fig:1723}
\end{figure}

In addition to the diagonal trajectories, the $x$ and $y$ component trajectories in open and closed loop are presented in Fig.~\ref{fig:expcomponents}. 
