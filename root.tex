...
\end{equation}
where $i = 1,\ldots,n$ and represents each decomposed part of the trajectory. If this condition is satisfied, then the trajectory is feasible. If not, the solver continues by adjusting the time and finds a solution tha satisfies the following conditions:
\begin{align}
