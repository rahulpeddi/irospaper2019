...
In our current and future work we plan to use onboard cameras and leverage machine vision techniques to enable autonomous flight and predict and bound future estimate about the reachable states of the system. The online adaptation part will be also expanded to consider safety critical situations like obstacle avoidance. More experiments with smoother trajectories are also in our agenda.
