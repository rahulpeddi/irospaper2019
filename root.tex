...
The first experiment consisted in tracking a diagonal path, to validate that $x$ and $y$ components can be attained accurately, as discussed in Section~\ref{sec:traj}. Starting from the world frame origin (0,0), we set the target goal to $(-1.7,2.3)$. The time set for this trajectory was $5.25$s. Using the regression training, we obtained the open-loop commands for the $x$ and $y$ directions, which are pictured in red in Figs.~\ref{fig:xcmds} and \ref{figs:ycmds}, respectively. The open-loop commands yield the trajectory in Fig.~\ref{fig:1723open}.
...
\begin{figure}[ht]
    ...
    \subfigure[$x$ Distance Traveled in Open and Closed Loop \label{fig:x2traj}]{\includegraphics[width=0.9\linewidth]{images/Xtrajs.png}}
    ...
    \subfigure[$y$ Distance Traveled in Open and Closed Loop \label{fig:y2traj}]{\includegraphics[width=0.9\linewidth]{images/Ytrajs.png}}
	\caption{Error and Control in the $x$ and $y$ Directions}
	\label{fig:1723controlled}
\end{figure}

The resultant diagonal trajectory is shown in Fig.~\ref{fig:1723closed}, and \ref{fig:diagquad} is an image of the experiment.
\begin{figure}[ht]
    \centering
    ...
    \subfigure[Closed Loop Results \label{fig:1723closed}]{\includegraphics[width=0.32\linewidth]{images/1723closed.png}}
     \subfigure[Experiment \label{fig:1723closed}]{\includegraphics[width=0.29\linewidth]{images/diagquad2.png}}
