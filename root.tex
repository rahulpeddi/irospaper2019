...
Along with the string of commands sent, the shaded portion of Fig.\ref{fig:sampleintegral}, represents the total area under the string of commands, or the integral. From \eqref{eq:cinputs}, we see that the changes in roll and pitch that dictate the inputs 
