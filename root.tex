...
\end{align}
where $\phi_c$ and $\theta_c$ are the desired roll and pitch angles, respectively, and $x_{des},~\dot{x}_{des},~\ddot{x}_{des}$ refer to the desired position, velocity, and acceleration in the $x$ direction, while $y_{des},~\dot{y}_{des},~\ddot{y}_{des}$ refer to the desired position, velocity, and acceleration in the $x$ direction, respectively.
