...
\begin{figure*}[tb!h]
	...
	\subfigure[Real V Trajectory. \label{fig:ex0}]{\includegraphics[width=0.32\textwidth]{images/FINAL_V.png}}
	\subfigure[Real A Trajectory. \label{fig:ex0}]{\includegraphics[width=0.32\textwidth]{images/FINAL_A.png}}
	\vspace{-5pt}
