...
The open-loop and version of the diagonal trajectories are presented in Fig.~\ref{fig:1723}, where it is clear that the closed-loop trajectory tracks to the target, while the open loop trajectory falls short of the setpoint. %\NB{where is the error plot?}
