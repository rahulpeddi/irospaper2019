...
\begin{figure}[ht]
    \centering
	\subfigure[Open Loop Diagonal Experiment\label{fig:1723open}]{\includegraphics[width=0.48\linewidth]{images/1723open.png}}
    \subfigure[Closed Loop Diagonal Experiment \label{fig:1723closed}]{\includegraphics[width=0.48\linewidth]{images/1723closed.png}}
    \caption{Open and Closed Loop Diagonal Experiment Results}
\end{figure}
