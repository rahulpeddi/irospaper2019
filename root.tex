...
\end{align}
where $\phi_c$ and $\theta_c$ are the desired roll and pitch angles, respectively, and $x_{des},~\dot{x}_{des},~\ddot{x}_{des}$ refer to the desires position, velocity, and acceleration in the $x$ direction, and the same definition applies for those quantities in the $y$ direction.
