...
\begin{figure}[h]
    \includegraphics[width=0.48\textwidth]{images/resizesample.png}
    \caption{A sample of the string generation process}
    \label{fig:resizesample}
\end{figure}
...
\begin{equation}
    \mathbf{x}_c(t+1) = \mathbf{x}_a(t+1) + k_p\xi(t)
\end{equation}

The proportional gain, $k_p$, is automatically tuned using the ratio of reference position to actual position. 
