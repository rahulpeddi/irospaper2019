...
\begin{figure}[h]
	\centering
	\subfigure[Sample of a Single Demonstration\label{fig:sampleintegral}]{\includegraphics[width=0.8\linewidth]{sampleintegral.png}}
	\subfigure[Sample Trajectory\label{fig:sampt}]{\includegraphics[width=0.8\linewidth]{sampletrajectory.png}}
	\subfigure[Sample Velocity\label{fig:sampv}]{\includegraphics[width=0.8\linewidth]{samplevelocity.png}}
