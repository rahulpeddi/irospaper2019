...
\begin{figure*}[tb!h]
	...
	\subfigure[Planned V Trajectory. \label{fig:ex0}]{\includegraphics[width=0.32\textwidth]{images/DESIRE_V.png}}
	\subfigure[Planned A Trajectory. \label{fig:ex0}]{\includegraphics[width=0.32\textwidth]{images/DESIRE_A.png}}
	\subfigure[Real U Trajectory. \label{fig:ex0}]{\includegraphics[width=0.32\textwidth]{images/FINAL_U.png}}
	\subfigure[Real V Trajectory. \label{fig:ex0}]{\includegraphics[width=0.32\textwidth]{images/DESIRE_V.png}}
	\subfigure[Real A Trajectory. \label{fig:ex0}]{\includegraphics[width=0.32\textwidth]{images/DESIRE_A.png}}
	\vspace{-5pt}
...
%\begin{figure*}[t]
%\subfigure[Planned U Trajectory]{\label{ex0}\includegraphics[width=0.3\textwidth]{images/DESIRE_U.png}}
%\subfigure[Planned V Trajectory]{\label{ex1}\includegraphics[width=0.3\textwidth]{images/DESIRE_V.png}}
%\subfigure[Planned A Trajectory]{\label{ex3}\includegraphics[width=0.3\textwidth]{images/DESIRE_A.png}}
%\subfigure[Real U Trajectory]{\label{ex4}\includegraphics[width=0.3\textwidth]{images/FINAL_U.png}}
%\subfigure[Real V Trajectory]{\label{ex5}\includegraphics[width=0.3\textwidth]{images/FINAL_V.png}}
%\subfigure[Real A Trajectory]{\label{ex6}\includegraphics[width=0.3\textwidth]{images/FINAL_A.png}}
%\caption{U, V, A Trajectory Experiments}
%\label{fig:UVA}
%\end{figure*}
...
%\subfigure[Real U Trajectory]{\label{ex4}
%\includegraphics[width=0.3\textwidth]{images/FINAL_U.png}}\hfill
%\subfigure[Real V Trajectory]{\label{ex5}
%\includegraphics[width=0.3\textwidth]{images/FINAL_V.png}}\hfill
%\subfigure[Real A Trajectory]{\label{ex6}
%\includegraphics[width=0.3\textwidth]{images/FINAL_A.png}}\\
%\caption{U, V, A Trajectory Experiments}
%\label{fig:UVA}
%\end{figure*}

Lastly, the letters U, V, and A were created and tracked with the UAV. using the same approach and the results are demonstrated in Fig.~\ref{fig:UVA}. For all of our tests we recorded a maximum error of ...when running our approach in open loop and ...when closing the loop. 
...
In this work, we have presented an approach that enables autonomous flight oF off-the-shelf quadrotors that are primarily tuned for teleoperation. Our approach shows that we can use a small training set along with a regression analysis to generate commands for any trajectory, along with adapting and closing the loop in real-time to reduce tracking error. Besides a framework for generating commands for autonomous operations, we have also proposed a statistical approach to estimate the error in the prediction and an SMT-based technique to minimize this error and generate safe inputs. Our experimental results show that the generated commands in open loop are close to the desired behavior but as expected not enough to guarantee robust tracking due to noise and disturbances at run-time. By adding a corrective procedure, however we demonstrate that we can achieve good trajectory tracking. 
