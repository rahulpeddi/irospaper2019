...
\begin{figure}[tp]
	...
	\label{fig:1723cmds}
\end{figure}
These open-loop commands send the UAV
...
The two diagonal trajectories are shown in Fig.~\ref{fig:1723trajs}.

\begin{figure}[ht!]
	\centering
	\subfigure[Open Loop Diagonal\label{fig:1723open}]{\includegraphics[width=0.9\columnwidth]{images/1723open.png}}
    \subfigure[Closed Loop Diagonal \label{fig:1723closed}]{\includegraphics[width=0.9\columnwidth]{images/1723closed.png}}
	\caption{Diagonal Trajectory in Open and Closed Loop}
	\label{fig:1723trajs}
\end{figure}
